...
- Version: **v1.4.0**
- Source commit: d3f45af
- Source tag:    no-exact-tag
- Vendored at:   2026-05-06T04:42:50Z
- Target:        <repo-root> (legal-research-agent)

To update this vendor copy, run `./scripts/vendor-into.sh <repo-root> (legal-research-agent)` from the citation-auditor repo (latest version).
