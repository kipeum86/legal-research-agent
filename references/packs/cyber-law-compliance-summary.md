...
2. Draft executive summary with High / Medium / Low risk priority matrix.
...
## Section 2 — Compliance Sections

Use this template for each section:

| Element | Content |
|---|---|
| Legal Requirement | Statutory/regulatory citation, Bluebook where applicable |
...
| 4 | Cross-Border Data Transfers | GDPR Arts. 44-49; SCCs; EU-U.S. Data Privacy Framework |
...
| Obligation | GDPR (EU) | CCPA/CPRA (CA) | Other Jurisdiction |
|---|---|---|---|
| Consent basis | Lawful basis required | Opt-out; sensitive data often opt-in | |
| Breach notification | 72 hrs to DPA | 72 hrs if statutory threshold met | |
| Data subject rights | Access, erasure, portability | Access, deletion, opt-out of sale/share | |

## Section 4 — Sensitive Data Categories
...
- [ ] Implement breach notification workflow and deadline triggers.
- [ ] Complete records of processing activities, where applicable.
...
- pending state privacy laws with enactment status and effective dates
...
- Tailor for industry: healthcare tech, fintech, e-commerce, and SaaS face different obligations.
...
- Include enforcement amounts where they contextualize regulatory seriousness.
- Distinguish enacted law from proposals.
